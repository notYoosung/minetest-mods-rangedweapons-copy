minetest.register_tool("rangedweapons2:remington_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons2:remington",
	loaded_sound = "rangedweapons_shotgun_reload_b",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_remington_rld.png",
})

minetest.register_tool("rangedweapons2:remington", {
...
RW_gun_capabilities = {
		...
		gun_crit = 4,
		gun_critEffc = 2.0,
		suitable_ammo = {{"rangedweapons2:shell",4}},
		gun_skill = {"shotgun_skill",20},
		gun_icon = "rangedweapons_remington_icon.png",
		gun_unloaded = "rangedweapons2:remington_rld",
		gun_cooling = "rangedweapons2:remington_uld",
		gun_velocity = 18,
		gun_accuracy = 40,
		gun_cooldown = 0.8,
		gun_gravity = 5,
...
minetest.register_tool("rangedweapons2:remington_uld", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	range = 0,
...
on_secondary_use = function(itemstack, user, pointed_thing)
eject_shell(itemstack,user,"rangedweapons2:remington_rld",0.8,"rangedweapons_shotgun_reload_a","rangedweapons2:empty_shell")
return itemstack
end,
})
