...
minetest.register_tool("rangedweapons2:tmp_r", {
	stack_max= 1,
	wield_scale = {x=1.15,y=1.15,z=1.15},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:tmp_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_tmp_rld.png",
})

minetest.register_tool("rangedweapons2:tmp_rr", {
	stack_max= 1,
	wield_scale = {x=1.15,y=1.15,z=1.15},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:tmp_rrr",
	load_sound = "rangedweapons_reload_a",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_tmp.png",
})

minetest.register_tool("rangedweapons2:tmp_rrr", {
	stack_max= 1,
	wield_scale = {x=1.15,y=1.15,z=1.15},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:tmp",
	load_sound = "rangedweapons_reload_b",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_tmp.png",
})

	minetest.register_tool("rangedweapons2:tmp", {
	stack_max= 1,
	wield_scale = {x=1.15,y=1.15,z=1.15},
