------------reload--------------------
minetest.register_tool("rangedweapons2:luger_r", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	rw_next_reload = "rangedweapons2:luger_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	inventory_image = "rangedweapons_luger.png",
})
minetest.register_tool("rangedweapons2:luger_rr", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	rw_next_reload = "rangedweapons2:luger_rrr",
	load_sound = "rangedweapons_reload_a",
	inventory_image = "rangedweapons_luger.png",
})
minetest.register_tool("rangedweapons2:luger_rrr", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	rw_next_reload = "rangedweapons2:luger",
	load_sound = "rangedweapons_reload_b",
	inventory_image = "rangedweapons_luger_rld.png",
})
minetest.register_tool("rangedweapons2:luger_rld", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	loaded_gun = "rangedweapons2:luger",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_luger_rld.png",
})
-----------------gun--------------

minetest.register_tool("rangedweapons2:luger", {
	...
	RW_gun_capabilities = {
		...
		gun_unloaded = "rangedweapons2:luger_r",
		gun_cooling = "rangedweapons2:luger_rld",
		gun_velocity = 20,
		gun_accuracy = 92,
		gun_cooldown = 0.625,
		gun_reload = 1.0/4,
