...
minetest.register_tool("rangedweapons2:thompson_r", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons2:thompson_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_thompson_rld.png",
})
minetest.register_tool("rangedweapons2:thompson_rr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons2:thompson_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_thompson.png",
})
minetest.register_tool("rangedweapons2:thompson_rrr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons2:thompson",
...
-------------------------------------------
	...
	minetest.register_tool("rangedweapons2:thompson", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.25},
