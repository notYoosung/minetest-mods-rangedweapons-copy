...
minetest.register_craftitem(":shell_shotgundrop", {
	wield_scale = {x=2.5,y=1.5,z=1.0},
	inventory_image = "rangedweapons_shelldrop_shotgun.png",
})

minetest.register_craftitem("rangedweapons2:shell_whitedrop", {
	wield_scale = {x=2.5,y=1.5,z=1.0},
	inventory_image = "rangedweapons_shelldrop_white.png",
})

minetest.register_craftitem("rangedweapons2:shell_grenadedrop", {
	wield_scale = {x=2.5,y=1.5,z=3.0},
	inventory_image = "rangedweapons_shelldrop_grenade.png",
})

minetest.register_craftitem("rangedweapons2:shelldrop", {
	wield_scale = {x=2.5,y=1.5,z=1.0},
	inventory_image = "rangedweapons_shelldrop.png",
})

minetest.register_craftitem("rangedweapons2:plastic_sheet", {
...
minetest.register_craftitem("rangedweapons2:gunsteel_ingot", {
...
minetest.register_craftitem("rangedweapons2:ultra_gunsteel_ingot", {
...
minetest.register_craftitem("rangedweapons2:gun_power_core", {
...
minetest.register_craftitem("rangedweapons2:power_particle", {
