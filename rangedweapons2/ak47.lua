...
minetest.register_tool("rangedweapons2:ak47_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:ak47_rr",
...
minetest.register_tool("rangedweapons2:ak47_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:ak47_rrr",
...
minetest.register_tool("rangedweapons2:ak47_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:ak47",
	...
	minetest.register_tool("rangedweapons2:ak47", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
