local he_boom = {
	name = "rangedweapons2:he_explosion",
...
local rocket_boom = {
	name = "rangedweapons2:rocket_explosion",
	--description = "DuN mInD mEh...",
	radius = 3,
	tiles = {
		side = "rangedweapons_invisible.png",
...
rangedweapons_rocket.on_step = function(self, dtime, pos)
	...
	local objs = minetest.get_objects_inside_radius({x = pos.x, y = pos.y, z = pos.z}, 1.5)
		...
		if obj:get_luaentity().name ~= "rangedweapons2:rocket" and obj:get_luaentity().name ~= "__builtin:item" then
...
minetest.register_entity("rangedweapons2:rocket", rangedweapons_rocket)
...
rangedweapons_he_grenade.on_step = function(self, dtime, pos)
	...
	local objs = minetest.get_objects_inside_radius({x = pos.x, y = pos.y, z = pos.z}, 1.5)
		for k, obj in pairs(objs) do
		if obj:get_luaentity() ~= nil then
		if obj:get_luaentity().name ~= "rangedweapons2:he_grenade" and obj:get_luaentity().name ~= "__builtin:item" then
		tnt.boom(pos, rocket_boom)
		self.object:remove()
			end
		end
...
minetest.register_entity("rangedweapons2:he_grenade", rangedweapons_he_grenade)


local barrel_boom = {
	name = "rangedweapons2:explosion",
	--description = "DuN mInD mEh...",
	radius = 3,
	tiles = {
		side = "rangedweapons_invisible.png",
...
minetest.register_node("rangedweapons2:barrel", {
