...
minetest.register_tool("rangedweapons2:awp_uld", {
	stack_max= 1,
...
eject_shell(itemstack,user,"rangedweapons2:awp_rld",1.0,"rangedweapons_rifle_reload_a","rangedweapons2:empty_shell")
return itemstack
end,
})


minetest.register_tool("rangedweapons2:awp_r", {
	rw_next_reload = "rangedweapons2:awp_rr",
...
minetest.register_tool("rangedweapons2:awp_rr", {
	rw_next_reload = "rangedweapons2:awp_rrr",
...
minetest.register_tool("rangedweapons2:awp_rrr", {
	rw_next_reload = "rangedweapons2:awp",
...
minetest.register_tool("rangedweapons2:awp_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons2:awp",
...
minetest.register_tool("rangedweapons2:awp", {
...
RW_gun_capabilities = {
		...
		gun_crit = 30,
		gun_critEffc = 3.0,
		suitable_ammo = {{"rangedweapons2:762mm",10},{"rangedweapons2:308winchester",10}},
		gun_skill = {"rifle_skill",20},
		gun_magazine = "rangedweapons2:rifle_mag",
		gun_icon = "rangedweapons_awp_icon.png",
		gun_unloaded = "rangedweapons2:awp_r",
		gun_cooling = "rangedweapons2:awp_uld",
		gun_velocity = 75,
		gun_accuracy = 100,
		gun_cooldown = 1.0,
		gun_reload = 2.0/4,
