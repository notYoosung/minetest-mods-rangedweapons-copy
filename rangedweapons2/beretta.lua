...
minetest.register_tool("rangedweapons2:beretta_rld", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	range = 0,
	loaded_gun = "rangedweapons2:beretta",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_beretta_rld.png",
})
minetest.register_tool("rangedweapons2:beretta_r", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	rw_next_reload = "rangedweapons2:beretta",
...
minetest.register_tool("rangedweapons2:beretta", {
...
RW_gun_capabilities = {
		...
		gun_crit = 15,
		gun_critEffc = 2.1,
		suitable_ammo = {{"rangedweapons2:9mm",15}},
		gun_skill = {"handgun_skill",43},
		gun_magazine = "rangedweapons2:handgun_mag_black",
		gun_icon = "rangedweapons_beretta_icon.png",
		gun_unloaded = "rangedweapons2:beretta_r",
		gun_cooling = "rangedweapons2:beretta_rld",
		gun_velocity = 25,
		gun_accuracy = 94,
		gun_cooldown = 0.4,
		gun_reload = 0.5,
