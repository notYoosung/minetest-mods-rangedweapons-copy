...
minetest.register_tool("rangedweapons2:javelin", {
...
RW_throw_capabilities = {
		...
		throw_texture = "rangedweapons2:thrown_javelin",
...
javStack = {name="rangedweapons2:javelin",wear=(bullet.wear)+(65535/throwDur)}
