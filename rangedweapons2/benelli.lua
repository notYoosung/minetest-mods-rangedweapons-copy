minetest.register_tool("rangedweapons2:benelli_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons2:benelli",
	loaded_sound = "rangedweapons_shotgun_reload_b",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_benelli_rld.png",
})

minetest.register_tool("rangedweapons2:benelli", {
...
RW_gun_capabilities = {
		...
		gun_crit = 6,
		gun_critEffc = 2.0,
		suitable_ammo = {{"rangedweapons2:shell",7}},
		gun_skill = {"shotgun_skill",20},
		gun_icon = "rangedweapons_benelli_icon.png",
		gun_unloaded = "rangedweapons2:benelli_rld",
		gun_cooling = "rangedweapons2:benelli_uld",
		gun_velocity = 25,
		gun_accuracy = 48,
		gun_cooldown = 0.6,
		gun_gravity = 4,
...
minetest.register_tool("rangedweapons2:benelli_uld", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	range = 0,
...
on_secondary_use = function(itemstack, user, pointed_thing)
eject_shell(itemstack,user,"rangedweapons2:benelli_rld",0.6,"rangedweapons_shotgun_reload_a","rangedweapons2:empty_shell")
return itemstack
end,
})
