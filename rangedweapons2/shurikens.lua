...
minetest.register_craftitem("rangedweapons2:wooden_shuriken", {
	...
	RW_throw_capabilities = {
		...
		throw_entity = "rangedweapons2:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "rangedweapons2:wooden_shuriken",
...
minetest.add_item(bullet.object:get_pos(), "rangedweapons2:wooden_shuriken") end end,
	},
...
minetest.register_craftitem("rangedweapons2:stone_shuriken", {
	...
	RW_throw_capabilities = {
		...
		throw_entity = "rangedweapons2:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "rangedweapons2:stone_shuriken",
		throw_projectile_size = 0.15,
...
minetest.add_item(bullet.object:get_pos(), "rangedweapons2:stone_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("rangedweapons2:steel_shuriken", {
	...
	RW_throw_capabilities = {
		...
		throw_entity = "rangedweapons2:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "rangedweapons2:steel_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 0,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "rangedweapons2:steel_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("rangedweapons2:bronze_shuriken", {
	...
	RW_throw_capabilities = {
		...
		throw_entity = "rangedweapons2:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "rangedweapons2:bronze_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 0,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "rangedweapons2:bronze_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("rangedweapons2:golden_shuriken", {
	...
	RW_throw_capabilities = {
		...
		throw_entity = "rangedweapons2:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "rangedweapons2:golden_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 1,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "rangedweapons2:golden_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("rangedweapons2:mese_shuriken", {
	...
	RW_throw_capabilities = {
		...
		throw_entity = "rangedweapons2:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "rangedweapons2:mese_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 1,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "rangedweapons2:mese_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
...
minetest.register_craftitem("rangedweapons2:diamond_shuriken", {
	...
	RW_throw_capabilities = {
		...
		throw_entity = "rangedweapons2:shot_bullet",
		throw_visual = "wielditem",
		throw_texture = "rangedweapons2:diamond_shuriken",
		throw_projectile_size = 0.15,
		throw_glass_breaking = 1,
		has_sparks = 1,
		ignites_explosives = 0,
...
minetest.add_item(bullet.object:get_pos(), "rangedweapons2:diamond_shuriken") end end,
	},
	on_use = function(itemstack, user, pointed_thing)
rangedweapons_yeet(itemstack, user)
return itemstack
