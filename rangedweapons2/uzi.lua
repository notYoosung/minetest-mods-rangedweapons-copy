...
minetest.register_tool("rangedweapons2:uzi_r", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "rangedweapons2:uzi_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_uzi_rld.png",
})
minetest.register_tool("rangedweapons2:uzi_rr", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "rangedweapons2:uzi_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_uzi.png",
})
minetest.register_tool("rangedweapons2:uzi_rrr", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "rangedweapons2:uzi",
...
-------------------------------------------
	...
	minetest.register_tool("rangedweapons2:uzi", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
