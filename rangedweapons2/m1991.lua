...
minetest.register_tool("rangedweapons2:m1991_rld", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	range = 0,
	loaded_gun = "rangedweapons2:m1991",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_m1991_rld.png",
})
minetest.register_tool("rangedweapons2:m1991_r", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	rw_next_reload = "rangedweapons2:m1991_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_m1991.png",
})
minetest.register_tool("rangedweapons2:m1991_rr", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	rw_next_reload = "rangedweapons2:m1991_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_m1991.png",
})
minetest.register_tool("rangedweapons2:m1991_rrr", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	rw_next_reload = "rangedweapons2:m1991",
...
minetest.register_tool("rangedweapons2:m1991", {
