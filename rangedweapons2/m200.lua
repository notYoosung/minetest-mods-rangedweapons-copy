...
minetest.register_tool("rangedweapons2:m200_uld", {
	stack_max= 1,
...
eject_shell(itemstack,user,"rangedweapons2:m200_rld",1.0,"rangedweapons_rifle_reload_a","rangedweapons2:empty_shell")
return itemstack
end,
})


minetest.register_tool("rangedweapons2:m200_r", {
	rw_next_reload = "rangedweapons2:m200_rr",
...
minetest.register_tool("rangedweapons2:m200_rr", {
	rw_next_reload = "rangedweapons2:m200_rrr",
...
minetest.register_tool("rangedweapons2:m200_rrr", {
	rw_next_reload = "rangedweapons2:m200",
...
minetest.register_tool("rangedweapons2:m200_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=2.1,y=2.1,z=1.2},
	description = "",
	loaded_gun = "rangedweapons2:m200",
...
minetest.register_tool("rangedweapons2:m200", {
...
RW_gun_capabilities = {
		...
		gun_crit = 33,
		gun_critEffc = 3.25,
		suitable_ammo = {{"rangedweapons2:408cheytac",7}},
		gun_skill = {"rifle_skill",12},
		gun_magazine = "rangedweapons2:rifle_mag",
		gun_icon = "rangedweapons_m200_icon.png",
		gun_unloaded = "rangedweapons2:m200_r",
		gun_cooling = "rangedweapons2:m200_uld",
		gun_velocity = 80,
		gun_accuracy = 100,
		gun_cooldown = 1.5,
		gun_reload = 2.5/4,
