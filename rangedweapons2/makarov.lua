...
minetest.register_tool("rangedweapons2:makarov_rld", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	loaded_gun = "rangedweapons2:makarov",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_makarov_rld.png",
})
minetest.register_tool("rangedweapons2:makarov_r", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:makarov_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_makarov.png",
})

minetest.register_tool("rangedweapons2:makarov_rr", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:makarov_rrr",
	load_sound = "rangedweapons_reload_a",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_makarov.png",
})

minetest.register_tool("rangedweapons2:makarov_rrr", {
	stack_max= 1,
	wield_scale = {x=0.9,y=0.9,z=1.0},
	description = "",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	rw_next_reload = "rangedweapons2:makarov",
	load_sound = "rangedweapons_reload_b",
	inventory_image = "rangedweapons_makarov_rld.png",
})


minetest.register_tool("rangedweapons2:makarov", {
