...
minetest.register_tool("rangedweapons2:g36_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:g36_rr",
...
minetest.register_tool("rangedweapons2:g36_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:g36_rrr",
...
minetest.register_tool("rangedweapons2:g36_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:g36",
	...
	minetest.register_tool("rangedweapons2:g36", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
