...
minetest.register_tool("rangedweapons2:deagle_rld", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	loaded_gun = "rangedweapons2:deagle",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_deagle_rld.png",
})
minetest.register_tool("rangedweapons2:deagle_r", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:deagle",
	load_sound = "rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_deagle_rld.png",
})

minetest.register_tool("rangedweapons2:deagle", {
...
RW_gun_capabilities = {
		...
		gun_crit = 20,
		gun_critEffc = 2.2,
		suitable_ammo = {{"rangedweapons2:357",9},{"rangedweapons2:44",8},{"rangedweapons2:50ae",7}},
		gun_skill = {"revolver_skill",40},
		gun_magazine = "rangedweapons2:handgun_mag_white",
		gun_icon = "rangedweapons_deagle_icon.png",
		gun_unloaded = "rangedweapons2:deagle_r",
		gun_cooling = "rangedweapons2:deagle_rld",
		gun_velocity = 50,
		gun_accuracy = 85,
		gun_cooldown = 0.7,
		gun_reload = 0.6/1,
...
minetest.register_tool("rangedweapons2:golden_deagle_rld", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	loaded_gun = "rangedweapons2:golden_deagle",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_golden_deagle_rld.png",
})
minetest.register_tool("rangedweapons2:golden_deagle_r", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:golden_deagle",
	load_sound = "rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_golden_deagle_rld.png",
})

minetest.register_tool("rangedweapons2:golden_deagle", {
...
RW_gun_capabilities = {
		...
		gun_unloaded = "rangedweapons2:golden_deagle_r",
		gun_cooling = "rangedweapons2:golden_deagle_rld",
		gun_velocity = 50,
		gun_accuracy = 90,
		gun_cooldown = 0.75,
		gun_reload = 0.6/1,
