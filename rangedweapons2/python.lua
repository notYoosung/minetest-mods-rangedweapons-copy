...
minetest.register_tool("rangedweapons2:python_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.25,y=1.25,z=1.1},
	description = "",
	loaded_gun = "rangedweapons2:python",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_python_rld.png",
})


minetest.register_tool("rangedweapons2:python", {
...
RW_gun_capabilities = {
		...
		gun_crit = 19,
		gun_critEffc = 2.2,
		suitable_ammo = {{"rangedweapons2:357",6}},
		gun_skill = {"revolver_skill",40},
		gun_icon = "rangedweapons_python_icon.png",
		gun_unloaded = "rangedweapons2:python_rld",
		gun_cooling = "rangedweapons2:python",
		gun_velocity = 55,
		gun_accuracy = 95,
		gun_cooldown = 0.2,
		gun_reload = 0.4,
