...
minetest.register_tool("rangedweapons2:rpk_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:rpk_rr",
...
minetest.register_tool("rangedweapons2:rpk_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:rpk_rrr",
...
minetest.register_tool("rangedweapons2:rpk_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:rpk",
	...
	minetest.register_tool("rangedweapons2:rpk", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
