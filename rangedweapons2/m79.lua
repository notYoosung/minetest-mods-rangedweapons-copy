...
minetest.register_tool("rangedweapons2:m79_r", {
	stack_max= 1,
	wield_scale = {x=2.0,y=2.0,z=2.5},
	range = 0,
	description = "", 
	groups = {not_in_creative_inventory = 1},
	rw_next_reload = "rangedweapons2:m79",
	load_sound = "rangedweapons_reload_a",
	inventory_image = "rangedweapons_m79_rld.png",
})

minetest.register_tool("rangedweapons2:m79", {
	...
	RW_gun_capabilities = {
		...
		gun_crit = 8,
		gun_critEffc = 3.0,
		suitable_ammo = {{"rangedweapons2:40mm",1}},
		gun_skill = {"",1},
		gun_magazine = "rangedweapons2:shell_grenadedrop",
		gun_icon = "rangedweapons_m79_icon.png",
		gun_unloaded = "rangedweapons2:m79_r",
		gun_cooling = "rangedweapons2:m79",
		gun_velocity = 20,
		gun_accuracy = 92,
		gun_cooldown = 0.0,
		gun_reload = 0.9,
