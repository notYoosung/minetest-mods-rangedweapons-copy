...
minetest.register_tool("rangedweapons2:glock17_rld", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	loaded_gun = "rangedweapons2:glock17",
	range = 0,
...
minetest.register_tool("rangedweapons2:glock17_r", {
	stack_max= 1,
	wield_scale = {x=1.2,y=1.2,z=1.2},
	description = "",
	rw_next_reload = "rangedweapons2:glock17_rr",
...
minetest.register_tool("rangedweapons2:glock17_rr", {
	stack_max= 1,
	wield_scale = {x=1.2,y=1.2,z=1.2},
	description = "",
	rw_next_reload = "rangedweapons2:glock17_rrr",
...
minetest.register_tool("rangedweapons2:glock17_rrr", {
	stack_max= 1,
	wield_scale = {x=1.2,y=1.2,z=1.2},
	description = "",
	rw_next_reload = "rangedweapons2:glock17",
...
minetest.register_tool("rangedweapons2:glock17", {
...
RW_gun_capabilities = {
		...
		gun_crit = 15,
		gun_critEffc = 2.2,
		suitable_ammo = {{"rangedweapons2:9mm",17},{"rangedweapons2:10mm",17},{"rangedweapons2:45acp",17}},
		gun_skill = {"handgun_skill",45},
		gun_magazine = "rangedweapons2:handgun_mag_black",
		gun_icon = "rangedweapons_glock17_icon.png",
		gun_unloaded = "rangedweapons2:glock17_r",
		gun_cooling = "rangedweapons2:glock17_rld",
		gun_velocity = 30,
		gun_accuracy = 96,
		gun_cooldown = 0.35,
		gun_reload = 0.9/4,
