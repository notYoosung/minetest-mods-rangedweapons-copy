minetest.register_craftitem("rangedweapons2:blue_ray_visual", {
	wield_scale = {x=1.75,y=1.75,z=1.75},
	inventory_image = "rangedweapons_blue_ray.png",
})

	minetest.register_tool("rangedweapons2:laser_blaster", {
	stack_max= 1,
...
RW_powergun_capabilities = {
		...
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "rangedweapons2:laser_blaster",
		power_velocity = 65,
		power_accuracy = 100,
		power_cooldown = 0.3,
		power_projectiles = 1,
		...
		power_entity = "rangedweapons2:shot_bullet",
		power_visual = "wielditem",
		power_texture = "rangedweapons2:blue_ray_visual",
