...
minetest.register_tool("rangedweapons2:aa12_r", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons2:aa12_rr",
	load_sound = "rangedweapons_rifle_clip_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_aa12_rld.png",
})
minetest.register_tool("rangedweapons2:aa12_rr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons2:aa12_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_aa12.png",
})
minetest.register_tool("rangedweapons2:aa12_rrr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons2:aa12",
...
-------------------------------------------
	...
	minetest.register_tool("rangedweapons2:aa12", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
