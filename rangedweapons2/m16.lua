...
minetest.register_tool("rangedweapons2:m16_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:m16_rr",
...
minetest.register_tool("rangedweapons2:m16_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:m16_rrr",
...
minetest.register_tool("rangedweapons2:m16_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons2:m16",
	...
	minetest.register_tool("rangedweapons2:m16", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
