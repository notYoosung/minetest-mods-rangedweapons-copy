minetest.register_craftitem("rangedweapons2:red_ray_visual", {
	wield_scale = {x=1.5,y=1.5,z=2.0},
	inventory_image = "rangedweapons_red_ray.png",
})

	minetest.register_tool("rangedweapons2:laser_rifle", {
...
RW_powergun_capabilities = {
		...
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "rangedweapons2:laser_rifle",
		power_velocity = 60,
		power_accuracy = 100,
		power_cooldown = 0.1,
		power_projectiles = 1,
		...
		power_texture = "rangedweapons2:red_ray_visual",
