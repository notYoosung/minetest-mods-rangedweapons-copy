...
minetest.register_alias("rangedweapons2:726mm", "rangedweapons2:762mm")

bullet_particles = bullet_particles or "rangedweapons_bullet_fly.png"


minetest.register_craftitem("rangedweapons2:shot_bullet_visual", {
...
initial_properties = {
	...
	textures = {"rangedweapons2:shot_bullet_visual"},
	lastpos = {},
...
if minetest.get_node(moveresult.collisions[1].node_pos).name == "rangedweapons2:barrel" then
...
local nodeName = minetest.get_node(moveresult.collisions[1].node_pos).name
	...
	minetest.swap_node(moveresult.collisions[1].node_pos, {name = "rangedweapons2:broken_glass"})
minetest.sound_play("glass_break",{moveresult.collisions[1].node_pos})
	end
	if   nodeName == "xpanes:pane" or
		nodeName == "xpanes:pane_flat" then
minetest.swap_node(moveresult.collisions[1].node_pos, {name = "air"})
minetest.add_item(moveresult.collisions[1].node_pos, "rangedweapons2:glass_shards")
minetest.sound_play("glass_break",{moveresult.collisions[1].node_pos})
	end
...
minetest.register_entity("rangedweapons2:shot_bullet", rangedweapons_shot_bullet) 
...
minetest.register_craftitem("rangedweapons2:drum_mag", {
	wield_scale = {x=1.0,y=1.0,z=1.5},
	inventory_image = "rangedweapons_drum_mag.png",
})

minetest.register_craftitem("rangedweapons2:handgun_mag_black", {
...
local rangedweapons_mag = {
	...
	textures = {"rangedweapons2:handgun_mag_black"},
	lastpos= {},
...
minetest.register_entity("rangedweapons2:mag", rangedweapons_mag)

minetest.register_craftitem("rangedweapons2:handgun_mag_white", {
	wield_scale = {x=0.6,y=0.6,z=0.8},
	inventory_image = "rangedweapons_handgun_mag_white.png",
})

minetest.register_craftitem("rangedweapons2:machinepistol_mag", {
	wield_scale = {x=0.6,y=0.6,z=0.8},
	inventory_image = "rangedweapons_machinepistol_mag.png",
})

minetest.register_craftitem("rangedweapons2:assaultrifle_mag", {
	wield_scale = {x=0.6,y=0.6,z=0.8},
	inventory_image = "rangedweapons_assaultrifle_mag.png",
})

minetest.register_craftitem("rangedweapons2:rifle_mag", {
	wield_scale = {x=0.6,y=0.6,z=0.8},
	inventory_image = "rangedweapons_rifle_mag.png",
})

minetest.register_craftitem("rangedweapons2:9mm", {
	stack_max= 500,
	...
	RW_ammo_capabilities = {
		...
		ammo_entity = "rangedweapons2:shot_bullet",
		ammo_visual = "wielditem",
		ammo_texture = "rangedweapons2:shot_bullet_visual",
		shell_entity = "rangedweapons2:empty_shell",
		shell_visual = "wielditem",
		shell_texture = "rangedweapons2:shelldrop",
		ammo_projectile_size = 0.0025,
		has_sparks = 1,
		ignites_explosives = 1,
	}
})
minetest.register_craftitem("rangedweapons2:45acp", {
	stack_max= 450,
	wield_scale = {x=0.4,y=0.4,z=1.2},
...
minetest.register_craftitem("rangedweapons2:10mm", {
	stack_max= 400,
	wield_scale = {x=0.4,y=0.4,z=1.2},
...
..core.colorize("#FFFFFF", "Bullet knockback: 1 \n")  ..core.colorize("#FFFFFF", "Bullet crit chance: 1% \n") ..core.colorize("#FFFFFF", "Ammunition for some guns"),
	...
	RW_ammo_capabilities = {
		...
		shell_entity = "rangedweapons2:empty_shell",
		shell_visual = "wielditem",
		shell_texture = "rangedweapons2:shell_whitedrop",
		ammo_projectile_size = 0.0025,
		has_sparks = 1,
		ignites_explosives = 1,
	}
...
minetest.register_craftitem("rangedweapons2:357", {
	stack_max= 150,
	wield_scale = {x=0.4,y=0.4,z=1.2},
...
minetest.register_craftitem("rangedweapons2:50ae", {
	stack_max= 100,
...
minetest.register_craftitem("rangedweapons2:44", {
	stack_max= 150,
	wield_scale = {x=0.4,y=0.4,z=1.2},
...
minetest.register_craftitem("rangedweapons2:762mm", {
	stack_max= 250,
	wield_scale = {x=0.4,y=0.4,z=1.2},
...
minetest.register_craftitem("rangedweapons2:556mm", {
	stack_max= 300,
	wield_scale = {x=0.4,y=0.4,z=1.2},
...
minetest.register_craftitem("rangedweapons2:shell", {
	stack_max= 50,
	wield_scale = {x=0.4,y=0.4,z=1.2},
	...
	RW_ammo_capabilities = {
		...
		shell_entity = "rangedweapons2:empty_shell",
		shell_visual = "wielditem",
		shell_texture = "rangedweapons2:shell_shotgundrop",
		ammo_gravity = 5,
...
minetest.register_craftitem("rangedweapons2:308winchester", {
	stack_max= 75,
	wield_scale = {x=0.4,y=0.4,z=1.2},
...
minetest.register_craftitem("rangedweapons2:408cheytac", {
	stack_max= 40,
...
minetest.register_craftitem("rangedweapons2:40mm", {
	stack_max= 25,
	...
	RW_ammo_capabilities = {
		...
		shell_entity = "rangedweapons2:empty_shell",
		shell_visual = "wielditem",
		shell_texture = "rangedweapons2:shell_grenadedrop",
...
minetest.register_craftitem("rangedweapons2:rocket", {
	stack_max= 15,
