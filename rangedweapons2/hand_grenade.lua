...
minetest.register_craftitem("rangedweapons2:pin", {
...
minetest.register_entity("rangedweapons2:grenade_pin", rangedweapons_grenade_pin)

local grenade_boom = {
	name = "rangedweapons2:grenade_explosion",
	...
	local gtimer = 0
minetest.register_craftitem("rangedweapons2:hand_grenade", {
	stack_max= 1,
...
if minetest.find_node_near(user:get_pos(), 10,"rangedweapons2:antigun_block")
then
	...
	minetest.sound_play("rangedweapons_reload_a", {user})
		itemstack = "rangedweapons2:hand_grenade_nopin"
local pos = user:get_pos()
pos.y = pos.y + 1.5
local pinEnt = minetest.add_entity(pos, "rangedweapons2:grenade_pin")
if pinEnt then
...
minetest.register_craftitem("rangedweapons2:hand_grenade_nopin", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = minetest.add_entity(pos, "rangedweapons2:grenade")
			if obj then
...
minetest.register_globalstep(function(dtime, player, pos)
	...
	local pos = player:get_pos()
		if player:get_wielded_item():get_name() == "rangedweapons2:hand_grenade_nopin" then
...
minetest.register_entity("rangedweapons2:grenade", rangedweapons_grenade)
