minetest.register_tool("rangedweapons2:spas12_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons2:spas12",
	loaded_sound = "rangedweapons_shotgun_reload_b",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_spas12_rld.png",
})

minetest.register_tool("rangedweapons2:spas12", {
...
RW_gun_capabilities = {
		...
		gun_crit = 7,
		gun_critEffc = 2.1,
		suitable_ammo = {{"rangedweapons2:shell",8}},
		gun_skill = {"shotgun_skill",20},
		gun_icon = "rangedweapons_spas12_icon.png",
		gun_unloaded = "rangedweapons2:spas12_rld",
		gun_cooling = "rangedweapons2:spas12_uld",
		gun_velocity = 32,
		gun_accuracy = 52,
		gun_cooldown = 0.45,
		gun_gravity = 3,
...
minetest.register_tool("rangedweapons2:spas12_uld", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	range = 0,
...
on_secondary_use = function(itemstack, user, pointed_thing)
eject_shell(itemstack,user,"rangedweapons2:spas12_rld",0.6,"rangedweapons_shotgun_reload_a","rangedweapons2:empty_shell")
return itemstack
end,
})
