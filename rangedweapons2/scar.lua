...
minetest.register_tool("rangedweapons2:scar_r", {
	stack_max= 1,
	wield_scale = {x=1.7,y=1.7,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons2:scar_rr",
...
minetest.register_tool("rangedweapons2:scar_rr", {
	stack_max= 1,
	wield_scale = {x=1.7,y=1.7,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons2:scar_rrr",
...
minetest.register_tool("rangedweapons2:scar_rrr", {
	stack_max= 1,
	wield_scale = {x=1.7,y=1.7,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons2:scar",
	...
	minetest.register_tool("rangedweapons2:scar", {
	stack_max= 1,
	wield_scale = {x=1.7,y=1.7,z=1.25},
...
..core.colorize("#FFFFFF", "penetration: 20%\n") ..core.colorize("#FFFFFF", "Gun type: Assault rifle\n") ..core.colorize("#FFFFFF", "Bullet velocity: 45"),
	...
	RW_gun_capabilities = {
		...
		gun_crit = 11,
		gun_critEffc = 2.75,
		suitable_ammo = {{"rangedweapons2:762mm",20},{"rangedweapons2:556mm",30}},
		gun_skill = {"arifle_skill",50},
		gun_magazine = "rangedweapons2:assaultrifle_mag",
		gun_icon = "rangedweapons_scar_icon.png",
		gun_unloaded = "rangedweapons2:scar_r",
		gun_velocity = 45,
		gun_accuracy = 85,
		gun_cooldown = 0.15,
		gun_reload = 1.2/4,
