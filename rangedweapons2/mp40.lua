	...
	minetest.register_tool("rangedweapons2:mp40_r", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:mp40_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	inventory_image = "rangedweapons_mp40_rld.png",
	groups = {not_in_creative_inventory = 1},
})
	minetest.register_tool("rangedweapons2:mp40_rr", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:mp40_rrr",
	load_sound = "rangedweapons_reload_a",
	inventory_image = "rangedweapons_mp40.png",
	groups = {not_in_creative_inventory = 1},
})
	minetest.register_tool("rangedweapons2:mp40_rrr", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	inventory_image = "rangedweapons_mp40.png",
	rw_next_reload = "rangedweapons2:mp40",
	load_sound = "rangedweapons_reload_b",
	groups = {not_in_creative_inventory = 1},
})

	minetest.register_tool("rangedweapons2:mp40", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.5},
