...
minetest.register_tool("rangedweapons2:taurus_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.25,y=1.25,z=1.1},
	description = "",
	loaded_gun = "rangedweapons2:taurus",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_taurus_rld.png",
})


minetest.register_tool("rangedweapons2:taurus", {
...
RW_gun_capabilities = {
		...
		gun_crit = 22,
		gun_critEffc = 3.1,
		suitable_ammo = {{"rangedweapons2:44",6}},
		gun_skill = {"revolver_skill",40},
		gun_icon = "rangedweapons_taurus_icon.png",
		gun_unloaded = "rangedweapons2:taurus_rld",
		gun_cooling = "rangedweapons2:taurus",
		gun_velocity = 55,
		gun_accuracy = 97,
		gun_cooldown = 0.2,
		gun_reload = 0.4,
