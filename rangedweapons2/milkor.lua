...
minetest.register_tool("rangedweapons2:milkor_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.75,y=1.75,z=2.0},
	description = "",
	loaded_gun = "rangedweapons2:milkor",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_milkor_rld.png",
})


minetest.register_tool("rangedweapons2:milkor", {
...
RW_gun_capabilities = {
		...
		gun_crit = 9,
		gun_critEffc = 3.0,
		suitable_ammo = {{"rangedweapons2:40mm",6}},
		gun_skill = {"",1},
		gun_magazine = "rangedweapons2:shell_grenadedrop",
		gun_icon = "rangedweapons_milkor_icon.png",
		gun_unloaded = "rangedweapons2:milkor_rld",
		gun_cooling = "rangedweapons2:milkor",
		gun_velocity = 30,
		gun_accuracy = 96,
		gun_cooldown = 0.35,
		gun_reload = 0.75,
