...
minetest.register_craftitem("rangedweapons2:tec9_r", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.50},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:tec9_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_tec9_rld.png",
})

minetest.register_craftitem("rangedweapons2:tec9_rr", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.50},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:tec9_rrr",
	load_sound = "rangedweapons_reload_a",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_tec9.png",
})

minetest.register_craftitem("rangedweapons2:tec9_rrr", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.50},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons2:tec9",
	...
	minetest.register_craftitem("rangedweapons2:tec9", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.50},
