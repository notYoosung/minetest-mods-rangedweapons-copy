...
minetest.register_tool("rangedweapons2:jackhammer_r", {
	stack_max= 1,
	wield_scale = {x=2.6,y=2.6,z=1.8},
	description = "",
	rw_next_reload = "rangedweapons2:jackhammer_rr",
	load_sound = "rangedweapons_rifle_clip_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_jackhammer_rld.png",
})
minetest.register_tool("rangedweapons2:jackhammer_rr", {
	stack_max= 1,
	wield_scale = {x=2.6,y=2.6,z=1.8},
	description = "",
	rw_next_reload = "rangedweapons2:jackhammer_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_jackhammer.png",
})
minetest.register_tool("rangedweapons2:jackhammer_rrr", {
	stack_max= 1,
	wield_scale = {x=2.6,y=2.6,z=1.8},
	description = "",
	rw_next_reload = "rangedweapons2:jackhammer",
...
-------------------------------------------
	...
	minetest.register_tool("rangedweapons2:jackhammer", {
	stack_max= 1,
	wield_scale = {x=2.6,y=2.6,z=1.8},
	...
	RW_gun_capabilities = {
		...
		gun_crit = 7,
		gun_critEffc = 2.2,
		suitable_ammo = {{"rangedweapons2:shell",10}},
		gun_skill = {"shotgun_skill",35},
		gun_magazine = "rangedweapons2:drum_mag",
		gun_icon = "rangedweapons_jackhammer_icon.png",
		gun_unloaded = "rangedweapons2:jackhammer_r",
		gun_velocity = 30,
		gun_accuracy = 35,
		gun_cooldown = 0.25,
		gun_reload = 1.6/4,
