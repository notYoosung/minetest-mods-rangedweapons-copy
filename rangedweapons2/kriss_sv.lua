...
minetest.register_tool("rangedweapons2:kriss_sv_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.15},
	description = "",
	rw_next_reload = "rangedweapons2:kriss_sv_rr",
...
minetest.register_tool("rangedweapons2:kriss_sv_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.15},
	description = "",
	rw_next_reload = "rangedweapons2:kriss_sv_rrr",
...
minetest.register_tool("rangedweapons2:kriss_sv_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.15},
	description = "",
	rw_next_reload = "rangedweapons2:kriss_sv",
	...
	minetest.register_tool("rangedweapons2:kriss_sv", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.15},
	...
	RW_gun_capabilities = {
		...
		gun_crit = 6,
		gun_critEffc = 1.95,
		suitable_ammo = {{"rangedweapons2:9mm",33},{"rangedweapons2:10mm",33},{"rangedweapons2:45acp",13}},
		gun_skill = {"mp_skill",90},
		gun_magazine = "rangedweapons2:machinepistol_mag",
		gun_icon = "rangedweapons_kriss_sv_icon.png",
		gun_unloaded = "rangedweapons2:kriss_sv_r",
		gun_velocity = 20,
		gun_accuracy = 60,
		gun_cooldown = 0.05,
		gun_reload = 0.9/4,
